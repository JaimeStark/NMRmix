...
# -*- coding: utf-8 -*-
#
# NMRmix documentation build configuration file, created by
# sphinx-quickstart on Mon Dec 28 14:05:16 2015.
#
...
latex_documents = [
  (master_doc, 'NMRmix.tex', 'NMRmix Documentation',
   'Jaime Stark', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'NMRmix', 'NMRmix Documentation',
   author, 'NMRmix', 'A tool for the optimization of compound mixtures in 1D 1H NMR ligand affinity screens.',
   'Miscellaneous'),
]
