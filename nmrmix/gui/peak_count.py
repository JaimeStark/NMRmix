...
class Window(QDialog):
    ...
    def calculateHistogram(self):
        ...
        self.ax.annotate("Mean: %.1f ± %.1f" % (self.mean, self.stdev), xy=(0.70, 0.82), xycoords='figure fraction',
                         horizontalalignment='left')
        self.ax.annotate("Median: %d" % (int(self.median)), xy=(0.70, 0.79), xycoords='figure fraction',
                         horizontalalignment='left')
        self.ax.annotate("Most Peaks: %d" % max(data), xy=(0.70, 0.76), xycoords='figure fraction',
                         horizontalalignment='left')
        self.ax.annotate("Fewest Peaks: %d" % min(data), xy=(0.70, 0.73), xycoords='figure fraction',
                         horizontalalignment='left')
